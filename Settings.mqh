...
class PanelSettings
{
   ...
   private:        
      ...
      PanelSettings()
      {
         ...
         setForActivePos.Add(new DefColumn(COLUMN_MAGIC, magic, 100, false));                setForHistoryPos.Add(new DefColumn(COLUMN_MAGIC, magic, 60, false));
         setForActivePos.Add(new DefColumn(COLUMN_SYMBOL, symbol, 70, false));               setForHistoryPos.Add(new DefColumn(COLUMN_SYMBOL, symbol, 60, false));
         setForActivePos.Add(new DefColumn(COLUMN_ENTRY_ORDER_ID, entryOrderId, 80, false)); setForHistoryPos.Add(new DefColumn(COLUMN_ENTRY_ORDER_ID, entryOrderId, 90, false));
