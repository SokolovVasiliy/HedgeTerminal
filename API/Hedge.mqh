   ...
   private:
      /*void TestNewClasses(ulong ticket)
      {
         ...
         CloseResult* cresult = actPos.AddClosingOrder(order);
          ...
          1. Создаем ордер на основе сделки.
            2. Узнаем, является ли этот ордер закрывающим.
            3. Если ордер закрывающий ищем активную позицию.
               4. Если активная позиция не найдена - создаем ее на основе открывающего ордера и вставляем в список активных позиций.
               5. Извлекаем активную позицию из списка.
               6. Закрываем активную позицию закрывающим ордером.
               7  Анализируем результат.
            8. Если ордер открывающий, ищем активную позицию к которой надо присоиденить этот ордер, либо создаем новую активную позицию.
