...
#ifdef HEDGE_PANEL
///
/// Тип обновления линий после сворачивания разворачивания позиции.
///
enum ENUM_REFRESH_LINES
{
   ...
   REFRESH_ALL,
   ///
   /// Обновить линии распологающиеся после свернутой/развернутой позиции.
   ///
   REFRESH_AFTER,
   ///
   /// Не обновлять линии.
...
class EventCollapseTree : public Event
{
   public:
      ...
      ///
      /// Возвращает истину, если требуется обновление для текущей строки и ложь в противном случае.
      ///
      bool NeedRefresh(){return needRefresh;}
      ///
      /// Устанавливает режим обновления для строки.
      ///
   ...
   private:
      ...
      int n_line;
      ///
      /// Истина, если требуется обновление и ложь в противном случае.
      ///
      bool needRefresh;
};
#endif
